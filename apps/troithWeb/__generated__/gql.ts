 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetInvoicesCountByDateRange (\n    $endingDate: String!\n    $monthsFromStart: Int!\n  ) {\n    invoiceCountByDateRange(invoicesCountByDateRangeInput: {\n      endingDate: $endingDate\n      monthsFromStart: $monthsFromStart\n    }) {\n      date\n      count\n    }\n  }"): (typeof documents)["query GetInvoicesCountByDateRange (\n    $endingDate: String!\n    $monthsFromStart: Int!\n  ) {\n    invoiceCountByDateRange(invoicesCountByDateRangeInput: {\n      endingDate: $endingDate\n      monthsFromStart: $monthsFromStart\n    }) {\n      date\n      count\n    }\n  }"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation CreateUom(\n      $abbreviation: String!\n      $name: String!\n      $companyId: String!\n    ) {\n    createUom(createUomInput:{\n      abbreviation: $abbreviation\n      name: $name\n      companyId: $companyId\n    }) {\n      id\n    }\n  }"): (typeof documents)["mutation CreateUom(\n      $abbreviation: String!\n      $name: String!\n      $companyId: String!\n    ) {\n    createUom(createUomInput:{\n      abbreviation: $abbreviation\n      name: $name\n      companyId: $companyId\n    }) {\n      id\n    }\n  }"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
