...
export type GetInvoicesCountByDateRangeQueryVariables = Exact<{
  endingDate: Scalars['String']['input'];
  monthsFromStart: Scalars['Int']['input'];
}>;


export type GetInvoicesCountByDateRangeQuery = { __typename?: 'Query', invoiceCountByDateRange: Array<{ __typename?: 'InvoiceCountByDateRange', date: string, count: number }> };
...
export const GetInvoicesCountByDateRangeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetInvoicesCountByDateRange"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"endingDate"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"monthsFromStart"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"invoiceCountByDateRange"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"invoicesCountByDateRangeInput"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"endingDate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"endingDate"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"monthsFromStart"},"value":{"kind":"Variable","name":{"kind":"Name","value":"monthsFromStart"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}}]} as unknown as DocumentNode<GetInvoicesCountByDateRangeQuery, GetInvoicesCountByDateRangeQueryVariables>;
